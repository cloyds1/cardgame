...
public class CardGameController {
    ...
    public void gameSetup() {
        ...
        // Now get number of rounds you want to play
        view.setText("How many rounds do you want to play?");
        view.setInput();
        numRounds = Integer.parseInt(view.getInput());
    ...
    public void playGame() {
        ...
        if (playerTurn < players.size() - 1) {
            ...
            playerTurn = 0;
            numRounds--; // decrement numRounds as round is over when the turn is reset to 0.
        }
    }
